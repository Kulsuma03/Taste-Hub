    ...
    return (
        <section className=" mt-7 flex items-center justify-center">
            ...
            <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl mt-0 p-5 items-center">
                ...
                <div className="md:w-1/2 px-8 md:px-16  rounded-md">
                    <h2 className="font-bold text-2xl text-[#F53313]">Login</h2>
                    ...
                    <form action="" className="flex flex-col gap-4">
                        ...
                        <button type='submit' className="bg-[#061724]  rounded-xl text-white py-2 hover:scale-105 duration-300">Login</button>
                    </form>
                    ...
                    <div className="text-xs border-b border-[#061724] py-4 text-[#061724]">
                    ...
                    <div className="mt-3 pb-2 text-xs flex justify-between items-center text-[#061724]">
                        ...
                        <Link to='/register'>
                            <button className="py-2 font-bold px-5 bg-white border rounded-xl hover:scale-110 text-[#F53313] duration-300">Register</button>
                        </Link>
                    </div>
                </div>
