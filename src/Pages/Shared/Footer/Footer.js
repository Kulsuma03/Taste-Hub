...
const Footer = () => {
    return (
        <footer className="px-4 mt-11 divide-y bg-[#08263F] text-gray-100">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        <h3 className="uppercase text-gray-50">Delivery System</h3>
                        <ul className="space-y-1">
                            <li>
                                <Link rel="noopener noreferrer" to="/">Home Delivery</Link>
                            </li>
                            <li>
                                <Link rel="noopener noreferrer" to="/">Pick Up</Link>
                            </li>
                            <li>
                                <Link rel="noopener noreferrer" to="/">Others</Link>
                            </li>
                        </ul>
                    </div>
                    <div className="space-y-3">
            ...
            <div className="py-6 text-sm text-center text-gray-400">© 2022 Taste Hub. All rights reserved.</div>
        </footer>
    );
};
